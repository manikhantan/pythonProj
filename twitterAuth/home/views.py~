...
def login(request):
	a = '<a class="twitter_button submit_button" href="/" action_mousedown="SignupTwitterClick" tabindex="6" id="__w2_ChdKUQJ_twitter_connect_button"><img src="https://g.twimg.com/dev/sites/default/files/images_documentation/sign-in-with-twitter-gray.png"></a>'
...
def callback(request):
	...
	try:
		...
		return HttpResponse("Error. Referesh again")
	...
	if access_token:
		...
		res = 'Hi '+access_token["screen_name"]+'<br/><br/><form name="tweetForm" method="post" action="/post_feed/"> Tweet:   <input type="text" name="tweetBox"><button name="button" value="OK" type="submit">Post</button></form>'
	...
	#return HttpResponse("Hi " + name + "<br/>" + post_feed(client, "whooo"))
